...
public final class Peer {
    ...
    public static Peer parse(final Iterable<? extends CharSequence> lines)
        ...
        for (final CharSequence line : lines) {
            final Attribute attribute = Attribute.Companion.parse(line).orElseThrow(() ->
    ...
    public String toWgQuickString() {
        ...
        if (!allowedIps.isEmpty())
            sb.append("AllowedIPs = ").append(Attribute.Companion.join(allowedIps)).append('\n');
    ...
    public static final class Builder {
        ...
        public Builder parseAllowedIPs(final CharSequence allowedIps) throws BadConfigException {
            try {
                for (final String allowedIp : Attribute.Companion.split(allowedIps))
                    addAllowedIp(InetNetwork.Companion.parse(allowedIp));
                return this;
